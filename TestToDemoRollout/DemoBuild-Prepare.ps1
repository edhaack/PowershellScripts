...
$jsVersion = "9.1-" + $DateStr
$tbcfDestinationDir = $prodBuildDir +"\The Build Config Files\Demo Build Config Files"
$demoCdxWebConfig = $tbcfDestinationDir + "\CDX\Web.config"
$prodCdxWebConfig = $tbcfDestinationDir + "\CDX\Web.config"
...
(Get-Content $demoCdxWebConfig) | Foreach-Object {$_ -replace "##JSVERSION##", $jsVersion} | Set-Content $demoCdxWebConfig
(Get-Content $prodCdxWebConfig) | Foreach-Object {$_ -replace "##JSVERSION##", $jsVersion} | Set-Content $prodCdxWebConfig
